...
import { InAppBrowserRedirectVI } from "../components/InAppBrowserRedirect";
...
function NAPvn() {
    ...
    if (!isInApp) {
      if (isMobile) {
        ...
        window.location.href =
          "hyp-global://launchgame?gamebiz=nap_global&openGame=true";
      }
    }
  }, []);
  ...
  return (
    <div>
      ...
      <p>
        {isMobile
          ? "Đang mở Zenless Zone Zero - Gamota..."
          : "Đang mở HoYoPlay..."}
      </p>
